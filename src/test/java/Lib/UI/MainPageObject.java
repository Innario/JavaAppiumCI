...
public class MainPageObject {
    ...
    public List<WebElement> waitForElementsPresent(By by, String error_message, long timeoutInSeconds, int number) {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
    ...
    public void scrollWebPageUp() { //Mobile Web
    ...
    public void clickElementToTheRightUpperCorner(String locator,String error_message){
        ...
        if (driver instanceof AppiumDriver) {
            ...
            WebElement element = this.waitForElementPresent(locator + "/..", error_message,1);
    ...
    public void swipeUpToFindElementToLeft(String locator, String error_message){
        if (driver instanceof AppiumDriver) {
